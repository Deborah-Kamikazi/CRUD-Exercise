...
const app = express()
const URL =  "mongodb+srv://user1:z3b2iSxG.Fb*.NE@cluster0.fx9vc.mongodb.net/data?retryWrites=true&w=majority&appName=Cluster0"
...
app.delete('/items/:id',async(req,res)=>{
    try {
        ...
        const Itemdeleted = await Items.findByIdAndDelete(id, req.body)
